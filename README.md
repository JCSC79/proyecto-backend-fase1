...
This project is part of **Phase 1** of the Backend Learning Path. It is a REST API built with **Node.js** and **Express**, using **TypeScript** in strict mode to ensure robust and professional development.
...
- **Development Engine:** [Nodemon](https://nodemon.io/) + [ts-node](https://typestrong.org/ts-node/)
...
- `src/`: Source code.
- `src/models/`: Data interfaces and enums.
